...
class CustomUserManager(BaseUserManager):
    ...
    def create_user(
        self, email, password, first_name, last_name, personal_number, birth_date, phone_number, **extra_fields
    ):
        """
    ...
    def create_superuser(
        ...
        **extra_fields
        ...
        return self.create_user(
            email, password, first_name, last_name, personal_number, birth_date, phone_number, **extra_fields
        )
